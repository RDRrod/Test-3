...
public class Bank extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Simple bank");

        jLabel2.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel2.setText("Money");

        jLabel3.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabel3.setText("Cryptocurrency");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        // Chech users money and crypt balance 
        
        try{
            Connection connect =Connect.getConnect();
            Statement stmt = connect.createStatement();
            String query = "Select crypt from human;";
            ResultSet rs = stmt.executeQuery(query);
            Double crypt = 0.0;
            while (rs.next()) {
                crypt = rs.getDouble("crypt");
            }
            String formattedDouble = String.format("%.2f", crypt ); 
        ...
        try{
            Connection connect =Connect.getConnect();
            Statement stmt = connect.createStatement();
            String query1 = "Select balance from human;";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (money>0){
                ...
                stmt.executeUpdate("UPDATE human set balance = balance + '"+money+"' where id='1'");
                JOptionPane.showMessageDialog(null,"Complited");
            }
            else JOptionPane.showMessageDialog(null, "Not enough money or entered incorrectly ");
        } catch(Exception e){}
